# Archived PICARD1 Onboarding

> **Deprecated:** This portal documents the legacy PICARD1 implementation. The active PICARD2 onboarding portal is at [`../../index.html`](../../index.html). Keep this directory as historical evidence; do not use its architecture or setup instructions for current development.
