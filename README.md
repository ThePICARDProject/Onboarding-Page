...
- PICARD's purpose as a continuation of Dr. Thomas Devine's graduate research;
- the rare-event, big-data, and distributed-computing problem behind the project;
...
Update the portal whenever the research contract, current product state, near-term destination, or product assumptions change. Keep research vision, current implementation, and near-term commitments visibly distinct.
